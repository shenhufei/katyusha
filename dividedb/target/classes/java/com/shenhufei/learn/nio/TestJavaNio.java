package com.shenhufei.learn.nio;
...
public class TestJavaNio {
    ...
    public static String pathname = "f://1.doc";
    public static String filename = "f://2.doc";
    ...
    public static void readNIO() {
        ...
        try {
            ...
            System.out.println(JSONArray.toJSONString(channel));
            channel.close();
    ...
    public static void writeNIO() {
        ...
        try {
            ...
            System.out
                    .println("初始化容量和limit：" + bf.capacity() + "," + bf.limit());
            int length = 0;
